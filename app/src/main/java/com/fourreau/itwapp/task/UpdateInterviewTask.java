 ...
 */
public class UpdateInterviewTask extends AsyncTask<String, Void, AsyncTaskResult<Interview>> {
    ...
    public UpdateInterviewTask(Activity activity, InterviewService interviewService, String interviewId, Map<String, Object> param){
